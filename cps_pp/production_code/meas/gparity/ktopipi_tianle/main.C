...
//	doConfigurationSplit(conf,params,cmdline,field3dparams,field4dparams);
	doConfigurationCrusherSplit(conf,params,cmdline,field3dparams,field4dparams);
      }
//      else if(cmdline.do_crusher_benchmark)
//      {
//        doBenchmarkCrusher(conf,params,cmdline,field3dparams,field4dparams);
//      }
      else
