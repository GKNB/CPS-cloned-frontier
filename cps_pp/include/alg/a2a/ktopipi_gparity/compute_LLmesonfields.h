...
#define INHERIT(A) typedef typename computeMesonFieldsBase<Vtype,Wtype>::A A;
...
public:
  ...
  static void computeMesonFields(MesonFieldMomentumContainer<MesonFieldType> &mf_ll_con, //container for 1s pion output fields, accessible by ThreeMomentum of pion
...
private:
  ...
  static void store(MesonFieldMomentumContainer<MesonFieldType> &mf_ll_con,
		    const PionMomentumPolicy &pion_mom,
		    const int src_idx,
...
public:
  ...
  static void computeMesonFields(MesonFieldMomentumContainer<MesonFieldType> &mf_ll_1s_con, //container for 1s pion output fields, accessible by ThreeMomentum of pion
				 MesonFieldMomentumContainer<MesonFieldType> &mf_ll_2s_con, //same for 2s source
				 const std::string &work_dir, const int traj,  //all meson fields stored to disk
				 const PionMomentumPolicy &pion_mom, //object that tells us what quark momenta to use
				 Wtype &W, Vtype &V,
				 const Float &rad, //exponential wavefunction radius
...
template<typename Vtype, typename Wtype, typename MomentumPolicy, int SpinMatrix, FlavorMatrixType FlavorMatrix>
...
template<typename Vtype, typename Wtype, typename PionMomentumPolicy, int SpinMatrix, FlavorMatrixType FlavorMatrix>
...
public:
  ...
  typedef GparityFlavorProjectedShiftSourceSumStorage<Vtype,Wtype, InnerType> StorageType;
...
public:
  ...
  static void computeMesonFields(MesonFieldMomentumContainer<MesonFieldType> &mf_con, //container for 1s pion output fields, accessible by ThreeMomentum of pion
				 const PionMomentumPolicy &pion_mom, //object that tells us what quark momenta to use
				 Wtype &W, Vtype &V,
				 Lattice &lattice,
				 const FieldParamType &src_setup_params = NullObject()){
...
public:
  ...
  static void computeMesonFields(MesonFieldMomentumContainer<MesonFieldType> &mf_ll_1s_con, //container for 1s pion output fields, accessible by ThreeMomentum of pion
				 MesonFieldMomentumContainer<MesonFieldType> &mf_ll_pt_con, //same for point source
				 const PionMomentumPolicy &pion_mom, //object that tells us what quark momenta to use
				 Wtype &W, Vtype &V,
				 const Float rad_1s, //exponential wavefunction radius
				 Lattice &lattice,
    ...
    MesonFieldMomentumContainer<MesonFieldType>* con[2] = { &mf_ll_1s_con, &mf_ll_pt_con };
