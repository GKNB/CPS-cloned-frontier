...
void ComputeKtoPiPiGparity<mf_Float>::type1_contract(KtoPiPiGparityResultsContainer &result, const int t_K, const int t_dis, const int thread_id, const SpinColorFlavorMatrix part1[2], const SpinColorFlavorMatrix part2[2]){
...
template<typename mf_Float>
void ComputeKtoPiPiGparity<mf_Float>::generateRandomOffsets(std::vector<OneFlavorIntegerField*> &random_fields, const std::vector<int> &tsep_k_pi, const int tstep, const int xyzStep){
...
template<typename mf_Float>
void ComputeKtoPiPiGparity<mf_Float>::type1_compute_mfproducts(std::vector<std::vector< A2AmesonField<mf_Float,A2AvectorWfftw,A2AvectorWfftw> > > &con_pi1_K,
...
template<typename mf_Float>
void ComputeKtoPiPiGparity<mf_Float>::type1_mult_vMv_setup(mult_vMv_split<mf_Float,A2AvectorV,A2AvectorWfftw,A2AvectorVfftw,A2AvectorW> &mult_vMv_split_part1_pi1,
...
template<typename mf_Float>
void ComputeKtoPiPiGparity<mf_Float>::type1_precompute_part1_part2(std::vector<SpinColorFlavorMatrix> &mult_vMv_contracted_part1_pi1,
...
void ComputeKtoPiPiGparity<mf_Float>::type1(KtoPiPiGparityResultsContainer result[],
  ...
  std::vector<A2AmesonField<mf_Float,A2AvectorWfftw,A2AvectorVfftw> > &mf_pi1 = mf_pions.get(p_pi_1); //*mf_pi1_ptr;
  std::vector<A2AmesonField<mf_Float,A2AvectorWfftw,A2AvectorVfftw> > &mf_pi2 = mf_pions.get(p_pi_2); //*mf_pi2_ptr;
  ...
  std::vector<std::vector< A2AmesonField<mf_Float,A2AvectorWfftw,A2AvectorWfftw> > > con_pi1_K(Lt); //[tpi][tsep_k_pi]
  std::vector<std::vector< A2AmesonField<mf_Float,A2AvectorWfftw,A2AvectorWfftw> > > con_pi2_K(Lt);
  ...
  for(int t_pi1_lin = 1; t_pi1_lin <= Lt; t_pi1_lin += tstep){ //Daiqian's weird ordering
    ...
    for(int top_loc = 0; top_loc < GJP.TnodeSites(); top_loc++){
      ...
      mult_vMv_split<mf_Float,A2AvectorV,A2AvectorWfftw,A2AvectorVfftw,A2AvectorW> mult_vMv_split_part1_pi1;
      mult_vMv_split<mf_Float,A2AvectorV,A2AvectorWfftw,A2AvectorVfftw,A2AvectorW> mult_vMv_split_part1_pi2;
      std::vector<mult_vMv_split<mf_Float,A2AvectorV,A2AvectorWfftw,A2AvectorWfftw,A2AvectorV> > mult_vMv_split_part2_pi1; //[ntsep_k_pi];
      std::vector<mult_vMv_split<mf_Float,A2AvectorV,A2AvectorWfftw,A2AvectorWfftw,A2AvectorV> > mult_vMv_split_part2_pi2; //[ntsep_k_pi];
...
# endif
      ...
      if(xyzStep > 1 && random_fields[t_pi1] == NULL) ERR.General("ComputeKtoPiPiGparity<mf_Float>","type1","Random field not initialized for t_pi1=%d (got %p) on node %d\n",t_pi1,random_fields[t_pi1],UniqueID());
