...
#  else
      ...
      //A2AmesonField<mf_Float,rA2AfieldR,rA2AfieldL> rreord_T;
...
#pragma omp parallel for
	...
	int i = ik % ni;
	int k = ik / ni;
	std::complex<mf_Float> const* lbase = &lreord(i,0);
	std::complex<mf_Float> const* rbase = &rreord(0,k);
	//std::complex<mf_Float> const* rbase = &rreord_T(k,0);
