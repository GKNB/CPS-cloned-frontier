...
struct flavorMatrixSpinColorContract{
  ...
  spinColorContract(FlavorMatrixGeneral<ComplexType> &lMr, const SCFvectorPtr<ComplexType> &l, const SCFvectorPtr<ComplexType> &r){
    ...
    /* for(int f1=0;f1<2;f1++) */
    /*   for(int f3=0;f3<2;f3++) */
    /* 	lMr(f1,f3) = l.isZero(f1) || r.isZero(f3) ? zero : GridVectorizedSpinColorContractSelect<smatidx,ComplexType,conj_left,conj_right>::doit(l.getPtr(f1),r.getPtr(f3)); */

    lMr(0,0) = l.isZero(0) || r.isZero(0) ? ComplexType(0.) : GridVectorizedSpinColorContractSelect<smatidx,ComplexType,conj_left,conj_right>::doit(l.getPtr(0),r.getPtr(0));
    lMr(0,1) = l.isZero(0) || r.isZero(1) ? ComplexType(0.) : GridVectorizedSpinColorContractSelect<smatidx,ComplexType,conj_left,conj_right>::doit(l.getPtr(0),r.getPtr(1));
    lMr(1,0) = l.isZero(1) || r.isZero(0) ? ComplexType(0.) : GridVectorizedSpinColorContractSelect<smatidx,ComplexType,conj_left,conj_right>::doit(l.getPtr(1),r.getPtr(0));
    lMr(1,1) = l.isZero(1) || r.isZero(1) ? ComplexType(0.) : GridVectorizedSpinColorContractSelect<smatidx,ComplexType,conj_left,conj_right>::doit(l.getPtr(1),r.getPtr(1));
