...
template< typename mf_Policies>
void A2AvectorWunitary<mf_Policies>::writeParallelByParts(const std::string &file_stub) const
{
...
template< typename mf_Policies>
void A2AvectorWunitary<mf_Policies>::readParallelByParts(const std::string &file_stub)
{
  typedef typename mf_Policies::ScalarFermionFieldType ScalarFermionFieldType;
  typedef typename mf_Policies::ScalarComplexFieldType ScalarComplexFieldType;
