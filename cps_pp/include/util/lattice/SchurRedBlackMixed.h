...
namespace Grid {
  ...
  public:
    ...
    SchurRedBlackBase(LinearFunction<Field> &HermitianRBSolver, const bool initSubGuess = false)  :
  ...
  public:
    ...
    SchurRedBlackStaggeredSolve(LinearFunction<Field> &HermitianRBSolver, const bool initSubGuess = false) 
  ...
  public:
    ...
    SchurRedBlackDiagMooeeSolve(LinearFunction<Field> &HermitianRBSolver, const bool initSubGuess = false)  
      : SchurRedBlackBase<Field> (HermitianRBSolver,initSubGuess) {};
  ...
  template<class Field> class SchurRedBlackDiagMooeeMixed : public SchurRedBlackBase<Field> {
  public:
    typedef CheckerBoardedSparseMatrixBase<Field> Matrix;

    SchurRedBlackDiagMooeeMixed(LinearFunction<Field> &HermitianRBSolver, const bool initSubGuess = false)  
      : SchurRedBlackBase<Field> (HermitianRBSolver,initSubGuess) {};
    ...
    virtual void RedBlackSolve   (Matrix & _Matrix,const Field &src_o, Field &sol_o)
    {
      SchurDiagMooeeOperator<Matrix,Field> _HermOpEO(_Matrix);
//      this->_HermitianRBSolver(_HermOpEO,src_o,sol_o);  assert(sol_o.checkerboard==Odd);
      this->_HermitianRBSolver(src_o,sol_o);  assert(sol_o.checkerboard==Odd);
    };
    virtual void RedBlackSolve   (Matrix & _Matrix,const std::vector<Field> &src_o,  std::vector<Field> &sol_o)
    {
      SchurDiagMooeeOperator<Matrix,Field> _HermOpEO(_Matrix);
  ...
  public:
    ...
    /////////////////////////////////////////////////////
  SchurRedBlackDiagTwoSolve(LinearFunction<Field> &HermitianRBSolver, const bool initSubGuess = false)  
    : SchurRedBlackBase<Field>(HermitianRBSolver,initSubGuess) {};
