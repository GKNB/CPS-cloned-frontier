...
//  $Header: /space/cvs/cps/cps++/src/alg/alg_ghb/comsrc/alg_ghb.C,v 1.14 2006/07/03 04:48:06 chulwoo Exp $
//  $Id: alg_ghb.C,v 1.14 2006/07/03 04:48:06 chulwoo Exp $
//  $Name: v5_0_16_hantao_io_test_v7 $
//  $Locker:  $
//  $RCSfile: alg_ghb.C,v $
//  $Revision: 1.14 $
//  $Source: /space/cvs/cps/cps++/src/alg/alg_ghb/comsrc/alg_ghb.C,v $
//  $State: Exp $
//
